<template>
	<view>
		<view class="top-tab-wrap">
			<view @click="clickShow(1)" :style="{color:isShowRegion ? '#059bfe' : ''}">{{regionName}}<text class="angle" :class="{'rotate-angle':isShowRegion}"></text></view>
			<view @click="clickShow(2)" :style="{color:isShowCate ? '#059bfe' : ''}" v-if="isRequireCate">{{cateName}}<text class="angle" :class="{'rotate-angle':isShowCate}"></text></view>
			<view @click="clickShow(3)" :style="{color:isShowTeam ? '#059bfe' : ''}" v-if="isRequireTeam">{{teamName}}<text class="angle" :class="{'rotate-angle':isShowTeam}"></text></view>
		</view>
