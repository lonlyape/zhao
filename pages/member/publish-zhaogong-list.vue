<template>
	<view class="container">
		<list-top defaultActive="zhaogong"></list-top>
				...
				<view class="b">
					...
					<view class="btn-group">
						...
						<block v-else-if="item.status != 3">
							<text class="btn" @click="jump('modify-zhaogong?work_id='+item.id)">修改</text>
						</block>
	...
	export default{
		...
		methods:{
			async getData(){
				...
				const data = {user_id:this.userInfo.uid,type:1,page:(this.refreshing ? 1 : this.page)};
